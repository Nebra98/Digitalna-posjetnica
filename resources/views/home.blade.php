        ...
        <div class="main-body">
            <div class="row gutters-sm">
                        ...
                        <div class="card-body opacity-25">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                <div class="picture-container">
                                    <div class="picture">
                                        <img src="{{ url('storage/uploads/avatar/' . Auth::user()->avatar) }}"
                                            class="picture-src" data-toggle="modal" data-target=".bd-example-modal-lg"
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLongTitle">{{ Auth::user()->name }} {{ Auth::user()->last_name }} - Slika profila</h5>
                                ...
                                <div class="mt-3">
                                    ...
                                    <a class="btn btn-dark" href="" role="button">Spremi kontakt</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($personal as $item)
                                @if ($item->title_per == $item->visible_per)
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        <h6 class="mb-0">{!! $item->icon_per !!} {{ $item->title_per }}</h6>
                                        <br>
                ...
                <div class="col-md-9">
                    ...
                    @if(count($personal) == 0 and count($socials) == 0 and count($contacts) == 0)
                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                    <strong style="font-size: 20px;">&#128543;</strong> Niste podijelili ni jednu
                                    informaciju drugim korisnicima.
                                    <br> Idite u "Moj profil" koji se nalazi u padajućem izborniku i ispunite određena
                                    polja.
                                ...
                                <ul class="list-group list-group-flush">
                                    @if ($social->title_soc == $social->visible_soc)
                                        <li
                                            ...
                                            <a class="btn btn-dark" href="{{ $social->content_soc }}"
                                                role="button">Pogledaj</a>
                                        </li>
                                    @endif
                                </ul>
                            @endforeach
