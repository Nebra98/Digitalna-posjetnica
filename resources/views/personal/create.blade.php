...
@section('content')
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-header"><i class="far fa-id-card"></i> Dodaj osobne podatke</div>
            ...
            <div class="card-body">
                ...
                <form name="add_name" id="add_name" method="POST" action="{{ route('personal.store') }}"
                            ...
                            <div id="field">
                                <div id="field0" class="row">
                                    <div class="form-group">
                                        <div class="col">
                                            <input type="text" name="title_per[]" placeholder="Naslov"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col">
                                            <input type="text" name="content_per[]" placeholder="Sadržaj"
                                                class="form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col">
                                            <input type="text" name="icon_per[]" placeholder="Ikonica"
                                                class="form-control" />
        ...
        $(document).ready(function() {
            ...
            $("#add-more").click(function(e) {
                ...
                var newIn = ' <div class="row" id="field' + next + '" name="field' + next +
                    '"><!-- Text input--><div class="form-group"> <label class="col-md-4 control-label" for="action_id"></label> <div class="col"> <input type="text" name="title_per[]" placeholder="Naslov" class="form-control" /> </div></div><br><br> <!-- Text input--><div class="form-group"> <label class="col-md-4 control-label" for="action_name"></label> <div class="col"> <input type="text" name="content_per[]" placeholder="Sadržaj" class="form-control" /> </div></div><br><br><!-- File Button --> <div class="form-group"> <label class="col-md-4 control-label" for="action_json"></label> <div class="col"> <input type="text" name="icon_per[]" placeholder="Ikonica" class="form-control" /><input type="hidden" name="visible_per[]" value="0" /><input type="hidden" id="user_id" name="user_id[]" value="{{ Auth::user()->id }}"> </div></div></div>';
                var newInput = $(newIn);
